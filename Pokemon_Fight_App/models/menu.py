...
diccionario_pokemon, test_label = seleccionar_enfrentamiento()
...
class Menu():
    def __init__(self, window):
        ...
        self.player_1 = Player(1, -20, 650, nombre_pokemon_1, nombre_pokemon_2)
        self.player_2 = Player(2, 750, 650, nombre_pokemon_1, nombre_pokemon_2)
    ...
    def draw_menu(self):
        ...
        self.player_2.answer(opcion_ia[0][0])
